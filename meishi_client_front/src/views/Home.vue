...
export default {
  data() {
    return {
      ...
      style: [
        "background-color: transparent;color: #000;height:81px;  width: 100%;",
        "background-color: #fff;color: #272b2c;height:81px;  width: 100%;",
      ],
      moni: 1,
      aft: "",
      eve: "",
  ...
  mounted() {
    ...
    window.addEventListener(
      ...
      () => {
        ...
        // console.log(
        //   "距离顶部高度",
        //   this.$refs.backTop.getBoundingClientRect().top
        // );
        if (window.pageYOffset > 416) {
          this.style1 = this.style[1];
          this.src=top_logo
          // console.log(this.style1);
        } else {
          this.style1 = this.style[0];
          this.src=logo
